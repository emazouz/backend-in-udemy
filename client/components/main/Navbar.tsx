          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            {isLogin ? (
              <div className="relative hidden md:block group">
                <div className="w-12 h-12 bg-amber-600 rounded-full flex justify-center items-center">
                ...
                >
                  <div className="hidden group-hover:block p-2">
                    ...
                    <button
                      ...
                      className="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-md text-red-700 hover:bg-red-50 dark:text-red-500 dark:hover:bg-red-600/10"
                      role="menuitem"
                    >
                      Logout
                    </button>
              ...
              <Link
                to="/login"
                className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75 bg-blue-900 px-3 py-2 rounded-lg text-lg"
              >
                Login
              </Link>
            )}
